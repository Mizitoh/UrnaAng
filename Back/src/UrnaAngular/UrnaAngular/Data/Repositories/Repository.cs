...
namespace UrnaAngular.Data.Repositories
{
    public class Repository : IRepository
    {
        ...
        // Candidatos
        public async Task<Candidato[]> GetAllCandidatosAsync()
        {
        ...
        public async Task<Candidato> GetCandidatoAsyncById(int candidatoId)
        {
            IQueryable<Candidato> query = _context.Candidatos;
            query = query.AsNoTracking().Where(cd => cd.Id == candidatoId);
        ...
        public async Task<Voto[]> GetAllVotosAsync()
        {
            IQueryable<Voto> query = _context.Votos.Include(vt => vt.Candidato);

            return await query.ToArrayAsync();
        }

        public async Task<Voto> GetVotosByLegendaAsync(int legenda)
        {
            IQueryable<Voto> query = _context.Votos;
            query = query.AsNoTracking().Where(vt => vt.Candidato.Legenda == legenda);
